...
{
    internal sealed class PluginUsageSyncService : IDisposable
    {
        ...
        public PluginUsageSyncService(PluginUsageRepository repository, ErrorGuard errorGuard)
        {
        ...
        {
            RunSync(source ?? "PluginUsageSync.Manual");
        }

        private void OnTimer(object state)
        {
            RunSync("PluginUsageSync.Timer");
        }
