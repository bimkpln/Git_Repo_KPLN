...
namespace KPLN_Library_DBWorker.FactoryParts.SQLite
{
    ...
    /// </summary>
    public class SQLiteCreatorRevitDialogtService : AbsCreatorDbService<SQLiteConnection, SQLiteException>
    {
        public override DbServiceAbstr<SQLiteConnection, SQLiteException> CreateService()
        {
            ...
            return new SQLiteRevitDialogService(connectionString, DBRevitDialog.CurrentDB);
        }
    }
}
