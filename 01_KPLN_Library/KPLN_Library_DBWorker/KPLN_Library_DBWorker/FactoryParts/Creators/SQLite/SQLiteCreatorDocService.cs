...
namespace KPLN_Library_DBWorker.FactoryParts.SQLite
{
    ...
    /// </summary>
    public class SQLiteCreatorDocService : AbsCreatorDbService<SQLiteConnection, SQLiteException>
    {
        public override DbServiceAbstr<SQLiteConnection, SQLiteException> CreateService()
        {
            ...
            return new SQLiteDocService(connectionString, DBDocument.CurrentDB);
        }
    }
}
