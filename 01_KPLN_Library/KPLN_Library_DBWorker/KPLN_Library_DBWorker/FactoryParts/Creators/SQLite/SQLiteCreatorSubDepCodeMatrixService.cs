...
namespace KPLN_Library_DBWorker.FactoryParts.SQLite
{
    ...
    /// </summary>
    public class SQLiteCreatorSubDepCodeMatrixService : AbsCreatorDbService<SQLiteConnection, SQLiteException>
    {
        public override DbServiceAbstr<SQLiteConnection, SQLiteException> CreateService()
        {
            ...
            return new SQLiteSubDepCodeMatrixService(connectionString, DBSubDepartmentCodeMatrix.CurrentDB);
        }
    }
}
