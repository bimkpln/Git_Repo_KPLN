...
namespace KPLN_Library_DBWorker.FactoryParts.SQLite
{
    ...
    /// </summary>
    public class SQLiteCreatorPluginActivityService : AbsCreatorDbService<SQLiteConnection, SQLiteException>
    {
        public override DbServiceAbstr<SQLiteConnection, SQLiteException> CreateService()
        {
            ...
            return new SQLitePluginActivityService(connectionString, DBPluginActivity.CurrentDB);
        }
    }
}
