...
namespace KPLN_Library_DBWorker.FactoryParts.SQLite
{
    ...
    /// </summary>
    public class SQLiteCreatorPrjAccessMatrixService : AbsCreatorDbService<SQLiteConnection, SQLiteException>
    {
        public override DbServiceAbstr<SQLiteConnection, SQLiteException> CreateService()
        {
            ...
            return new SQLitePrjAccessMatrixService(connectionString, DBProjectsAccessMatrix.CurrentDB);
        }
    }
}
