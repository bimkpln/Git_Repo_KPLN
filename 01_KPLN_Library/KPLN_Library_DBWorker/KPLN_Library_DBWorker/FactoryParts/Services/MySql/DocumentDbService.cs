...
namespace KPLN_Library_DBWorker.FactoryParts.MySql
{
    ...
    /// </summary>
    public class DocumentDbService : MySQLService
    {
        internal DocumentDbService(string connectionString, DBEnumerator dbEnumerator) : base(connectionString, dbEnumerator)
        {
        }
