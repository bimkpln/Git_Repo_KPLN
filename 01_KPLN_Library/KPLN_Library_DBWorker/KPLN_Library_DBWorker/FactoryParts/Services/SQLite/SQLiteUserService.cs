...
namespace KPLN_Library_DBWorker.FactoryParts.SQLite
{
    ...
    /// </summary>
    public class SQLiteUserService : SQLiteService
    {
        private readonly string _sysUserName = System.Security.Principal.WindowsIdentity.GetCurrent().Name.Split('\\').Last();

        internal SQLiteUserService(string connectionString, DBEnumerator dbEnumerator) : base(connectionString, dbEnumerator)
        {
        }
