...
namespace KPLN_Library_DBWorker.FactoryParts.SQLite
{
    ...
    /// </summary>
    public class SQLiteSubDepService : SQLiteService
    {
        private readonly SQLiteSubDepCodeMatrixService _subDepartmentCodeMatrixDbService;

        internal SQLiteSubDepService(string connectionString, DBEnumerator dbEnumerator) : base(connectionString, dbEnumerator)
        {
            _subDepartmentCodeMatrixDbService = (SQLiteSubDepCodeMatrixService)new SQLiteCreatorSubDepCodeMatrixService().CreateService();
        }
