...
namespace KPLN_Library_DBWorker.FactoryParts.SQLite
{
    ...
    /// </summary>
    public class SQLitePrjService : SQLiteService
    {
        internal SQLitePrjService(string connectionString, DBEnumerator dbEnumerator) : base(connectionString, dbEnumerator)
        {
        }
