...
namespace KPLN_Loader
{
    public static class Preferences
    {
        ...
        public static Tools_SQL SQLiteDataBase = new Tools_SQL();
        public static SQLUserInfo User = null;
        ...
        public enum MessageType { Header, Regular, Error, Warning, Critical, Code, Success, System_OK, System_Regular }
        public enum MessageDialogType { Regular, Warning, Important, Fun, System }
        public enum MessageDialogResult { Read, Ok, Thx, Close, None, Pending, Shown }
    }
}
