    ...
    public class Module : IExternalModule
    {
        ...
        public Result Execute(UIControlledApplication application, string tabName)
        {
            ...
            AddPushButtonDataInPullDown(
                ...
                string.Format(
                    "Запусти на плане-доноре, и ЛИБО предварительно выбери планы для замены в диспетчере проекта, ЛИБО выбери из их списка.\n" +
            ...
            AddPushButtonDataInPullDown(
               ...
               pullDown_Views,
               "ViewTemplateCopySolo",
               "http://moodle/mod/book/view.php?id=502&chapterid=1343"
           );

            AddPushButtonDataInPullDown(
                "ViewTemplateCopy",
                "Пакетное копирование\nшаблонов вида",
                "Копировать шаблоны вида в несколько файлов",
                string.Format(
